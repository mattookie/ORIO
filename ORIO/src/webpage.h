...
<body class="flex flex-col items-center justify-start p-4 md:p-8">
    ...
    <main id="viewContainer" class="w-full max-w-lg flex-grow">
        ...
        <!-- 4. TRACK VIEW -->
        <section id="TRACK_VIEW" class="hidden p-4 bg-gray-800 rounded-xl shadow-lg border-b-4 border-[#c9a8f1]">
            <h2 class="text-2xl font-bold mb-4 text-[#c9a8f1]">Automatic Tracking</h2>
